...
function OfferLetterDoc({ d }) {
  ...
  return (
    <div id="ol-document" style={{ background: "#f0f4f8" }}>

      {/* PAGE 1: COVER */}
      <div style={{ ...page, padding: 0, minHeight: "297mm", display: "flex", flexDirection: "column" }}>
...
export default function App() {
  ...
  const downloadPDF = async () => {
    ...
    const opt = {
      ...
      pagebreak: { mode: ["css", "legacy"], before: "#ol-document > div:not(:first-child)" },
    };
