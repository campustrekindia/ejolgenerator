  ...
  return (
    <div style={{ marginBottom: 12 }}>
      ...
      <input value={value} onChange={e => onChange(e.target.value)}
        style={{ width: "100%", padding: "9px 12px", border: "1.5px solid #e2e8f0", borderRadius: 6, fontSize: 13, fontFamily: FONT, color: "#0f172a", outline: "none", background: "#fff" }}
  ...
  return (
    <>
      <style>{`
        ...
        .preview-scroll { overflow-x: auto; border-radius: 10px; box-shadow: 0 4px 24px rgba(0,0,0,0.12); }
        /* Preview pages stacked with gap */
        #ol-pages { background: #e8edf4; display: flex; flex-direction: column; gap: 12px; padding: 12px; }
        #ol-pages > div { border-radius: 4px; box-shadow: 0 2px 12px rgba(0,0,0,0.15); }
